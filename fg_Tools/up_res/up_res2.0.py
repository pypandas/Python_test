        ...
        if os.path.isdir(os.path.join(res_path, and_file)):
            ...
            if os.path.exists(os.path.join('../', 'Phone', 'AssetBundle', up_path, and_file)):
                ...
                try:
                    ...
                    if os.path.exists(os.path.join('../', 'Phone', 'AssetBundle', up_path, and_file, 'lua.zip')):
                ...
                shutil.rmtree(os.path.join(res_path, and_file, 'resources'))
                if os.path.exists(os.path.join('../', 'Phone', 'AssetBundle', up_path, and_file, 'resources.zip')):
    ...
    try:
        ...
        if os.path.exists(lua_path):
            ...
            if write_xml(xml_path, str(temp.find('LobbyLuaMD5').text), lua_md5):
                write_xml(xml_path, '<LobbyLuaVersion>' + str(lus_version), '<LobbyLuaVersion>' + str(lus_version + 1))
        ...
        if write_xml(xml_path, str(temp.find('LobbyResMD5').text), res_md5):
            write_xml(xml_path, '<LobbyResVersion>' + str(res_version), '<LobbyResVersion>' + str(res_version + 1))
